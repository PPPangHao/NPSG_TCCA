...
def add_args(parser):
    ...
    parser.add_argument('--config_file', required=False,
                        default="configs/tcma_train_configs/MAHNOB_HCI_TSCAN_BASIC.yaml", type=str, help="The name of the model.")
...
if __name__ == "__main__":
    ...
    print(f"qqqqqqqqqq: {args.config_file}")
    # configurations.
    ...
    if config.TOOLBOX_MODE == "train_and_test":
        ...
        elif config.TRAIN.DATA.DATASET == "MAHNOB-HCI":
            train_loader = data_loader.MAHNOBHCIrPPGLoader.MAHNOBHCIrPPGLoader
        else:
        ...
        elif config.VALID.DATA.DATASET == "MAHNOB-HCI":
            valid_loader = data_loader.MAHNOBHCIrPPGLoader.MAHNOBHCIrPPGLoader
    ...
    if config.TOOLBOX_MODE == "train_and_test" or config.TOOLBOX_MODE == "only_test":
        ...
        elif config.TEST.DATA.DATASET == "MAHNOB-HCI":
            test_loader = data_loader.MAHNOBHCIrPPGLoader.MAHNOBHCIrPPGLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
                             SCAMPS, BP4D+ (Normal and BigSmall preprocessing), UBFC-PHYS and iBVP.")
        ...
        elif config.UNSUPERVISED.DATA.DATASET == "MAHNOB-HCI":
            unsupervised_loader = data_loader.MAHNOBHCIrPPGLoader.MAHNOBHCIrPPGLoader
        else:
            raise ValueError("Unsupported dataset! Currently supporting UBFC-rPPG, PURE, MMPD, \
